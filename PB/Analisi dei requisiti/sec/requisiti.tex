...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l|X|c}
		...
		\hline
		RFD58	   & L'Utente generico e L'Utente base devono poter ricercare un ristorante attraverso luogo e filtri.  					& \autoref{Ricerca ristoranti per luogo} , \autoref{Ricerca ristoranti per filtri} \\
		\hline
		RFO59	   & L'Utente ristoratore deve poter visualizzare la lista degli ingredienti necessari per soddisfare gli ordini di una giornata & \autoref{usecase:Consultazione lista ingredienti} \\ \hline
