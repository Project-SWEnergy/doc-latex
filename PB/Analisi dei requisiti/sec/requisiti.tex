...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l|X|c}
		...
		\hline
		RVO2        & L'applicazione \textit{web} sarà supportata dai seguenti \textit{browser}: Google Chrome v.106, Arc v.1.26, Opera GX v.108, Firefox v.124 , Safari v.17.3 , Microsfot Edge v.123  & Capitolato     \\
		\hline
	\end{tabularx}
