...
\begin{longtable}{|p{0.10\linewidth}|p{0.70\linewidth}|p{0.12\linewidth}|}
	...
	\hline
	TS.RFO8                                                                                                                         &
	L'Utente generico deve visualizzare un messaggio di errore se l'accesso fallisce. \par
	Verificare che:
	\begin{itemize}
		\item l'utente non abbia già effettuato l'accesso al sistema.
	...
	\hline
	TS.RFO9                                                                                                                         &
	L'Utente generico deve visualizzare un messaggio di errore se la registrazione fallisce. \par
	Verificare che:
	\begin{itemize}
		\item l'utente non sia registrato nel sistema.
		\item l'utente non abbia già effettuato l'accesso al sistema.
	...
	\hline
	TS.RFF56                                                                                                                        &
	L'Utente generico deve poter effettuare l'accesso al Sistema attraverso un sistema di terze parti.
	\begin{itemize}
		\item l'utente deve essere correttamente registrato.
		\item l'utente non deve aver già effettuato l'accesso.
	\end{itemize}                                 &
	Non implementato                                                                                                                                                            \\
	\hline
	TS.RFD57                                                                                                                      &
	L’Utente generico e l’Utente base devono poter ricercare un ristorante attraverso luogo e filtri.
	\begin{itemize}
		\item la pagina di visualizzazione dei risotranti deve essere raggiungibile.
		\item la sezione dedicata ai filtri deve essere ben visibile.
		\item la selezione di un filtro deve comportare la modifica degli elementi presenti a schermo.
		\item i nuovi elementi presenti devono corrispondere al filtro selezionato.
	\end{itemize}                                 &
	Non implementato                                                                                                                                                            \\
	\hline
	TS.RFO58                                                                                                                     &
	L’Utente ristoratore deve poter visualizzare la lista degli ingredienti necessari per soddisfare gli ordini di una giornata.
	\begin{itemize}
		\item la pagina di visualizzazione dati deve essere raggiungibile.
		\item la sezione dedicata al riepilogo ingredienti deve essere ben visibile.
		\item i dati presenti devono essere inerenti solo alle prenotazioni non annullate o rifiutate.
	\end{itemize}                                 &
	Implementato                                                                                                                                                            \\
	\hline
	TS.RFO59                                                                                                                     &
	L’Utente base deve poter modificare la propria ordinazione.
	\begin{itemize}
		\item la pagina di visualizzazione delle ordinazioni deve essere raggiungibile.
		\item il pulsante per modificare l'ordinazione deve essere ben visibile.
