...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l|X|p{2cm}}
		...
		\hline
		RFD4        & L'Utente generico deve poter condividere un \textit{link} di un ristorante.                                         & \autoref{usecase:Condivisione link del ristorante}                                                                                                           \\
		\hline
		RFD5        & L'Utente generico deve poter visualizzare la pagina delle  \textit{\ac{FAQ}$^G$}.                                             & \autoref{usecase:Visualizzazione FAQ}                                                                                                                        \\
		\hline
