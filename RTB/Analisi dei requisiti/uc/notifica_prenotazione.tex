\usecasebase{Notifica prenotazione} %attore principale corretto, e colui che interagisce attivamente con la notifica. sarebbe da mettere un attore secondario DB che è colui che viene inerrogato per soddisfare il bisogno dell attore primario
