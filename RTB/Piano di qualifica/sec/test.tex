...
\begin{longtable}{|p{0.10\linewidth}|p{0.70\linewidth}|p{0.12\linewidth}|}
    ...
    \hline
    TS.RFO2 & 
    L’Utente generico e l’Utente base devono poter ricercare un ristorante attraverso filtri: % ----------> TODO
    \begin{itemize}
        \item x.
        \item y.
        \item z.
    ...
    \hline
    TS.RFO35 & 
    L'utente autenitcato deve poter comunicare attraverso la \textit{chat}.\par 
    Verificare che: 
    \begin{itemize}
        \item l'utente sia correttamente autenticato.
