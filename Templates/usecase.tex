...
\newcommand{\usecase}[1]{%
	...
	\addcontentsline{toc}{usecase}{\protect\numberline{UC-\theusecase}\hspace{0.5cm}#1}%
}
\makeatother
...
\newcommand{\usecasegenerico}[1]{%
	...
	\addcontentsline{toc}{usecasegenerico}{\protect\numberline{UCG-\theusecasegenerico}\hspace{0.5cm}#1}%
}
\makeatother
...
\newcommand{\usecasebase}[1]{%
	...
	\addcontentsline{toc}{usecasebase}{\protect\numberline{UCB-\theusecasebase}\hspace{0.5cm}#1}%
}
\makeatother
...
\newcommand{\usecaseristoratore}[1]{%
	...
	\addcontentsline{toc}{usecaseristoratore}{\protect\numberline{UCR-\theusecaseristoratore}\hspace{0.5cm}#1}%
}
\makeatother
...
\newcommand{\usecaseerrore}[1]{%
	...
	\addcontentsline{toc}{usecaseerrore}{\protect\numberline{UCE-\theusecaseerrore}\hspace{0.5cm}#1}%
}
\makeatother
...
\newcommand{\usecaseautenticato}[1]{%
	...
	\addcontentsline{toc}{usecaseautenticato}{\protect\numberline{UCA-\theusecaseautenticato}\hspace{0.5cm}#1}%
}
\makeatother
