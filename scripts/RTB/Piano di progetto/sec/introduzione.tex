...
\begin{itemize}
	\item \textbf{\gls{Cliente}$^G$}: consente ai clienti di prenotare un tavolo presso un
	      ristorante, visualizzare il menù e effettuare un \gls{Ordine}$^G$;
...
\begin{itemize}
	...
	\item 	\href{https://www.math.unipd.it/~tullio/IS-1/2023/Progetto/C3.pdf}
	      {Documento del \gls{Capitolato}$^G$ d'appalto C3 - \textit{Easy Meal}};
